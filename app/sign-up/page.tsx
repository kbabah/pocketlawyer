...
function SignUpContent() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-4 sm:left-10 w-48 sm:w-96 h-48 sm:h-96 bg-primary/5 rounded-full blur-3xl -z-10 pointer-events-none" />
      <div className="absolute bottom-20 right-4 sm:right-10 w-48 sm:w-96 h-48 sm:h-96 bg-orange-100/30 dark:bg-orange-900/10 rounded-full blur-3xl -z-10 pointer-events-none" />
